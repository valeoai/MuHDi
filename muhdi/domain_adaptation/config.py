...
from muhdi.utils.serialization import yaml_load
...
cfg.DATA_LIST_SOURCE = str(project_root / 'muhdi/dataset/gta5_list/{}.txt')
cfg.DATA_LIST_TARGET = (str(project_root / 'muhdi/dataset/cityscapes_list/{}.txt'),)
# Directories
...
cfg.TRAIN.INFO_TARGET = (str(project_root / 'muhdi/dataset/cityscapes_list/info.json'),)
...
cfg.TRAIN.DISTILL = EasyDict()
cfg.TRAIN.DISTILL.FEAT = True
cfg.TRAIN.DISTILL.FEAT_LAMBDA = 1.0e-5
cfg.TRAIN.DISTILL.KT_LOGITS = True
cfg.TRAIN.DISTILL.KT_LAMBDA = 1.0e-5

# TEST CONFIGS
cfg.TEST = EasyDict()
cfg.TEST.MODE = 'best'  # {'single', 'best'}
cfg.TEST.ALL_RES = 'all_res.pkl'
# model
...
cfg.TEST.INFO_TARGET = (str(project_root / 'muhdi/dataset/cityscapes_list/info.json'),str(project_root / 'muhdi/dataset/idd_list/info.json'),'',)
